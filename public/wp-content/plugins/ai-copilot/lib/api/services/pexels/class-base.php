...
abstract class Base implements Route_Interface {
	...
	public function __construct() {
		...
		Services_Pexels_Routes_Library::instance()->register( $this );
	}

	public function register_rest_route() {
		register_rest_route(
			Services_Pexels_Routes_Library::get_namespace(),
	...
	public static function get_rest_path() {
		$rest_namespace = Services_Pexels_Routes_Library::get_namespace();
