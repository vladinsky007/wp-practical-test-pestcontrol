...
abstract class Base implements Route_Interface {
	...
	public function __construct() {
		...
		Actions_Templates_Routes_Library::instance()->register( $this );
	}

	public function register_rest_route() {
		register_rest_route(
			Actions_Templates_Routes_Library::get_namespace(),
	...
	public static function get_rest_path() {
		$rest_namespace = Actions_Templates_Routes_Library::get_namespace();
