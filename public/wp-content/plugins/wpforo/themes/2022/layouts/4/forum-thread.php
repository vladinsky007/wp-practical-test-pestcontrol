        ...
        <div class="wpf-thread-body">
            ...
            <div class="wpf-thread-box wpf-thread-title">
                ...
                <div class="wpf-thread-author-name">
					<span><?php wpforo_phrase('by') ?></span> <?php wpforo_member_link( $thread['user'] ) ?><span class="wpforo-date wpforo-date-ago">, <?php wpforo_date($thread['created'],'ago-date'); ?></span>&nbsp; <?php wpforo_tags($thread, true, 'text') ?>
                </div>
