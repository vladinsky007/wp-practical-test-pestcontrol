            ...
            <div class="wpforo-stat-table">
                ...
                <div class="wpf-row wpf-last-info">
                    <p class="wpf-stat-other">
						<?php if( $stat['last_post_title'] ): ?><span><i class="fas fa-pencil-alt"></i> <?php wpforo_phrase( 'Latest Post' ) ?>: <a href="<?php echo esc_url( (string) $stat['last_post_url'] ) ?>"><?php echo esc_html( $stat['last_post_title'] ) ?></a></span><?php endif; ?>
