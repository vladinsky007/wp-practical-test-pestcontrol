...
<div class="wpfl-3">
    <div class="wpforo-post-head">
        <div class="wpf-left">&nbsp;
            <a href="<?php echo esc_url( (string) wpforo_post( $topic['last_post'], 'url' ) ); ?>" class="wpfcl-2"><i class="far fa-caret-square-down wpfsx wpfcl-3"></i> &nbsp; <span class="wpfcl-3"><?php wpforo_phrase( 'Last Post' ); ?></span></a>
                        ...
                        <div class="wpf-right">
                            ...
                            <div class="wpforo-post-content">
								...
								<?php if( wpforo_setting( 'profiles', 'signature' ) ): ?>
									<?php if( trim( (string) $member['signature'] ) ): ?>
